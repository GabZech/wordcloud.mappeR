...
subtitle: "A package for creating wordcloud maps in R"
...
![](./index_files/images/merged_DEU_ITA.png "Wordcloud maps for Germany and Italy")
...
![](./index_files/images/merged_rm_outsidepng.png "When rm_outside = FALSE")
...
![](./index_files/images/max_10.png "When max_word_size = 10")
...
![](./index_files/images/scales.png "The 4 available scales")

```{r include=FALSE}
source("./update_readme.R")
update_readme()
#knit("../README.Rmd", output = "../README.md")
#file.copy(from = "./README.md", to = "../README.md", overwrite = TRUE)
